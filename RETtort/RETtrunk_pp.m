...
% happened
%
% Distanza = minimum disance between two breaking points
%
%
% Sintax:
%
...
function [xzero,yzero,dzero,k,indici] = RETtrunk_pp(ppx,ppy,ppd,x,y,d,lmin,h,passo,dbf)
...
for ct1=lmin:sx-lmin,
    ...
    case 1,
        ...
        case 1,
            ...
            %spezza solo se il nuovo pezzo e' suff. lungo
            if l>lmin
                ct2=ct2+1;
                indici(ct2)=ni;
                bonex(ct2)=x(ni);
